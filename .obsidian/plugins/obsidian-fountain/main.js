...
var fountain = createCommonjsModule(function (module) {
(function() {
...
function parseFountain(text, container) {
    fountain.parse(text, function (output) {
        container.innerHTML = output.html.script;
    });
}
var FountainPlugin = /** @class */ (function (_super) {
    __extends(FountainPlugin, _super);
    function FountainPlugin() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    FountainPlugin.prototype.onload = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.registerMarkdownCodeBlockProcessor('fountain', function (source, el) { return __awaiter(_this, void 0, void 0, function () {
                    var container;
                    return __generator(this, function (_a) {
                        container = el.createDiv({
                            cls: "screenplay"
                        });
    ...
    FountainPlugin.prototype.fountainViewCreator = function (leaf) {
        return new FountainView(leaf);
    };
    FountainPlugin.prototype.onunload = function () {
        console.log('unloading Fountain Plugin');
    };
    return FountainPlugin;
}(obsidian.Plugin));
var FountainView = /** @class */ (function (_super) {
    __extends(FountainView, _super);
    function FountainView(leaf) {
        var _this = _super.call(this, leaf) || this;
        // Get View Container Element
        _this.viewEl = _this.containerEl.getElementsByClassName('view-content')[0];
        // Add Preview Mode Container
        _this.previewEl = _this.viewEl.createDiv({ cls: 'screenplay', attr: { 'style': 'display: block' } });
        // Add Source Mode Container
        _this.sourceEl = _this.viewEl.createDiv({ cls: 'fountain-source-view', attr: { 'style': 'display: none' } });
        // Add code mirro editor
        _this.editorEl = _this.sourceEl.createEl('textarea', { cls: 'fountain-cm-editor' });
        // Create Code Mirror Editor with specific config
        _this.editor = codemirror.fromTextArea(_this.editorEl, {
            lineNumbers: false,
            lineWrapping: true,
            scrollbarStyle: null,
            keyMap: "default"
    ...
    FountainView.prototype.onload = function () {
        var _this = this;
        var changeMode = this.containerEl.getElementsByClassName('view-actions')[0].createEl('a', { cls: 'view-action', attr: { 'aria-label': 'Edit' } });
        obsidian.setIcon(changeMode, 'pencil', 17);
        changeMode.onClickEvent(function () {
            var currentMode = _this.previewEl.style.getPropertyValue('display');
            if (currentMode == "block") {
                _this.previewEl.style.setProperty('display', 'none');
                _this.sourceEl.style.setProperty('display', 'block');
                _this.editor.refresh();
                return;
            }
            _this.render();
            _this.previewEl.style.setProperty('display', 'block');
            _this.sourceEl.style.setProperty('display', 'none');
        });
        // Save file on change
    ...
    FountainView.prototype.getViewData = function () {
        return this.editor.getValue();
    };
    FountainView.prototype.setViewData = function (data, clear) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    FountainView.prototype.clear = function () {
    ...
    FountainView.prototype.render = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, editorValue];
            });
        });
    };
    FountainView.prototype.getDisplayText = function () {
        if (this.file)
            return this.file.basename;
        else
            return "fountain (no file)";
    };
    FountainView.prototype.canAcceptExtension = function (extension) {
        return extension == 'fountain';
    };
    FountainView.prototype.getViewType = function () {
        return "fountain";
    };
    return FountainView;

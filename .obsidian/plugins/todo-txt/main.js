...
class TodoTxtView extends obsidian.TextFileView {
  ...
  onCodeMirrorMousedown(e) {
    ...
    return 0 !== e.button && 1 !== e.button || (isMod || 1 === e.button) && this.triggerClickableTokenAt(this.getMousePosition(e), e.shiftKey || 1 === e.button) && e.preventDefault();
  }

  triggerClickableTokenAt(e, t) {
    return obsidian.MarkdownSourceView.prototype.triggerClickableTokenAt.call(this, e, t);
  }

...
var CopyUrlInPreview = class extends import_obsidian.Plugin {
  ...
  onload() {
    ...
    this.register(onElement(document, "mouseover", ".pdf-embed iframe, .pdf-embed div.pdf-container, .workspace-leaf-content[data-type=pdf] iframe", this.showOpenPdfMenu.bind(this)));
    this.register(onElement(document, "mousemove", ".pdf-canvas", this.showOpenPdfMenu.bind(this)));
    if (import_obsidian.Platform.isDesktop) {
      this.register(onElement(document, "contextmenu", "img", this.onClick.bind(this)));
      this.register(onElement(document, "mouseover", ".cm-link, .cm-hmd-internal-link", this.storeLastHoveredLinkInEditor.bind(this)));
      this.register(onElement(document, "mouseover", "a.internal-link", this.storeLastHoveredLinkInPreview.bind(this)));
    } else {
